...
puts "Making activities.."
puces = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567514377/puces_avihwa.jpg",user: marc, name: 'Marché aux Puces', tod: 'Morning', price: 0, city: 'Saint-Ouen', description: 'Window-shopping (or lécher les vitrines to the locals) is a great way to take an indulgent peek at objets d’art and wild curiosities you’d never actually buy. The St-Ouen flea market and antiques fair is the perfect place to let your imagination run riot. Marvel at bearskin rugs, antique tapestries and brass diving bells in this decadently eccentric marketplace. (But try to keep your eyebrow-raising in check when you look at the price tags.) Hop off the metro at Porte de Clignancourt (line 4) and continue under the bridge until the souvenir stalls give way to side streets crammed with beautiful buys.')
