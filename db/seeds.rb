...
puces = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162105/x7t1ytjbis7dkxi55ijn.jpg",user: marc, name: 'Marché aux Puces', tod: 'Morning', price: 0, city: 'Saint-Ouen', description: 'Window-shopping (or lécher les vitrines to the locals) is a great way to take an indulgent peek at objets d’art and wild curiosities you’d never actually buy. The St-Ouen flea market and antiques fair is the perfect place to let your imagination run riot. Marvel at bearskin rugs, antique tapestries and brass diving bells in this decadently eccentric marketplace. (But try to keep your eyebrow-raising in check when you look at the price tags.) Hop off the metro at Porte de Clignancourt (line 4) and continue under the bridge until the souvenir stalls give way to side streets crammed with beautiful buys.')
basilique_sacre_coeur = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162031/oegfgwmmd0f0ui4sy7pe.jpg", user: janice, name: 'Basilique du Sacré-Coeur', tod: 'Afternoon', price: 0, city: 'Paris', description: 'This palatial white marble church crowns the lively Montmartre district in the 18th arrondissement. Its interior is bedecked with gold mosaics and towering stained-glass windows, and you can listen for the peal of one of the world’s heaviest bells. Visiting the basilica is free, but there’s a charge to ascend into the dome or explore the crypt.')
champ_mars = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162875/nooru2woz12rhnwrqkjk.jpg", user: janice, name: 'Parc du Champ de Mars', tod: 'Afternoon', price: '0', city: 'Paris', description: 'A lift to the peak of the Eiffel Tower can squeeze the budget but views below can be equally stunning, albeit from a different angle. Parc du Champ de Mars has lawns and flowerbeds manicured with military precision (as you’d expect from a former army marching ground). Bring a blanket, wine and the best picnic ingredients you can find to this expanse of greenery and wait for the light show at dusk to set La Tour Eiffel a-twinkle.')
marche_aligre = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162088/qmedpwebexkcqmffed6h.jpg", user: janice, name: 'Marché d’Aligre', tod: 'Morning', price: '0', city: 'Paris', description: 'Feast your eyes on the finest local produce at this fabulous covered food market on Place d’Aligre in the 12th arrondissement. Mountains of cheese, artisan butchers and a field of flower stalls can send you into sensory overload after wandering through a few aisles. Stop for a discreet glass of Bordeaux and get your hands floury on some crusty baguette. Ride metro line 8 to the Ledru-Rollin stop.')
arrene_lutece = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567161908/l0sfxc8dp0ypncu819rb.jpg", user: janice, name: 'Arènes de Lutèce', tod: 'Afternoon', price: '0', city: 'Paris', description: 'Trace the ruins of Paris’ Roman heritage at the Arènes de Lutèce in the Latin Quarter. Dating back to 1AD, it is thought to be the longest Roman amphitheatre ever constructed. While the arena no longer hosts gladiatorial fights, it does provide a space for a competitive sport no less formidable: pétanque.')
atelier_brancusi = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162011/ygqo3h8j93n08b26jgeu.jpg", user: marc, name: 'Atelier Brancusi', tod: 'Morning', price: '0', city: 'Paris', description: 'Immerse yourself in the smooth shapes of Brancusi’s sculpture with a free visit to his recreated studio in front of the Centre Pompidou. The Romanian-born abstract sculptor made a name for himself with famous works like The Kiss. This Brancusi workshop is a lovingly assembled and surprisingly intimate glimpse into the mind of an artist.')
canal_st_martin = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567078446/vhriqxhtkwi09sbtlrfs.jpg", user: janice, name: 'Canal St-Martin', tod: 'Evening', price: '0', city: 'Paris', description: 'Join chic Parisians at the water’s edge while the sun goes down or skip stones like the heroine of Amélie. This lively waterside haunt, between République and Gare du Nord in the 10th arrondissement, is the perfect spot to bring a picnic, pop a cork and eavesdrop on the locals.')
belleville = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162040/mo7ailzxyjt97mjggbrv.jpg",user: janice, name: 'belleville', tod: 'Morning', price: '0', city: 'Paris', description: 'A stroll along the streets of Belleville, a district with a history of rebellion and multicultural flair, is certain to fire the imagination. Belleville’s bustling Chinatown and artist residents make it a lively place to explore. Wander up rue de Belleville to see where tragic chanteuse (female singer) Edith Piaf is said to have been born under a street lamp, then turn right onto pedestrian rue Dénoyez where you ll find Paris’ most dazzling street art. End your Belleville encounter with a meander and flop over first-class views of the city from leafy Parc de Belleville.')
jadin_tueleries = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162077/bznwkozzlu1wrhtiv6xn.jpg", user: marc, name: 'Jardin des Tuileries', tod: 'Afternoon', price: '0', city: 'Paris', description: 'Give your Paris trip a regal feel by sweeping through the historic park between the Louvre and Place de la Concorde. Tread in the dainty footsteps of Marie-Antoinette and see where Napoléon built his triumphal arch.')
parc_monceau = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567162098/fbpowa1oesq7bmv4foqb.jpg", user: janice, name: 'Parc Monceau', tod: 'Evening', price: '0', city: 'Paris', description: 'If celebrity-spotting in a cemetery is too morbid, march among France’s greats in Parc Monceau, which has statues of luminaries like Chopin and celebrated writer Guy de Maupassant. The park’s rich history makes it a fascinating spot for a promenade: this peaceful green space was the site of a massacre in 1871, and was a favourite painting spot for Monet. Throw in an extra freebie with a gander at the wonderful collection of rarely seen Chinese statuary showcased in the Musée Cernuschi, a municipal Asian Art Museum inside an elegant mansion next to the park’s eastern entrance on av Vélasquez. Take line 2 to the Monceau metro station in the 8th arrondissement.')
