...
# basilique_sacre_coeur = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172205/pedro-lastra-suRvdiwP9Pk-unsplash_s584ln.jpg", user: janice, name: 'Basilique du Sacré-Coeur', tod: 'Afternoon', price: 0, city: 'Paris', description: 'This palatial white marble church crowns the lively Montmartre district in the 18th arrondissement. Its interior is bedecked with gold mosaics and towering stained-glass windows, and you can listen for the peal of one of the world’s heaviest bells. Visiting the basilica is free, but there’s a charge to ascend into the dome or explore the crypt.')
# champ_mars = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172205/jace-afsoon-_P6_cMSxGUw-unsplash_qiawol.jpg", user: janice, name: 'Parc du Champ de Mars', tod: 'Afternoon', price: '0', city: 'Paris', description: 'A lift to the peak of the Eiffel Tower can squeeze the budget but views below can be equally stunning, albeit from a different angle. Parc du Champ de Mars has lawns and flowerbeds manicured with military precision (as you’d expect from a former army marching ground). Bring a blanket, wine and the best picnic ingredients you can find to this expanse of greenery and wait for the light show at dusk to set La Tour Eiffel a-twinkle.')
...
# atelier_brancusi = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172205/robin-benzrihem-IyMKYQiH_BI-unsplash_zjppfg.jpg", user: marc, name: 'Atelier Brancusi', tod: 'Morning', price: '0', city: 'Paris', description: 'Immerse yourself in the smooth shapes of Brancusi’s sculpture with a free visit to his recreated studio in front of the Centre Pompidou. The Romanian-born abstract sculptor made a name for himself with famous works like The Kiss. This Brancusi workshop is a lovingly assembled and surprisingly intimate glimpse into the mind of an artist.')
# canal_st_martin = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172204/tristan-colangelo-d4OnMIl5OYk-unsplash_g19qjc.jpg", user: janice, name: 'Canal St-Martin', tod: 'Evening', price: '0', city: 'Paris', description: 'Join chic Parisians at the water’s edge while the sun goes down or skip stones like the heroine of Amélie. This lively waterside haunt, between République and Gare du Nord in the 10th arrondissement, is the perfect spot to bring a picnic, pop a cork and eavesdrop on the locals.')
# belleville = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172206/willian-west-TVyjcTEKHLU-unsplash_bfcs7o.jpg",user: janice, name: 'belleville', tod: 'Morning', price: '0', city: 'Paris', description: 'A stroll along the streets of Belleville, a district with a history of rebellion and multicultural flair, is certain to fire the imagination. Belleville’s bustling Chinatown and artist residents make it a lively place to explore. Wander up rue de Belleville to see where tragic chanteuse (female singer) Edith Piaf is said to have been born under a street lamp, then turn right onto pedestrian rue Dénoyez where you ll find Paris’ most dazzling street art. End your Belleville encounter with a meander and flop over first-class views of the city from leafy Parc de Belleville.')
# jadin_tueleries = Activity.create!(remote_photo_url: "https://res.cloudinary.com/nmozzer/image/upload/v1567172207/yeo-khee-hyZ8ln856Ag-unsplash_ztmxfi.jpg", user: marc, name: 'Jardin des Tuileries', tod: 'Afternoon', price: '0', city: 'Paris', description: 'Give your Paris trip a regal feel by sweeping through the historic park between the Louvre and Place de la Concorde. Tread in the dainty footsteps of Marie-Antoinette and see where Napoléon built his triumphal arch.')
